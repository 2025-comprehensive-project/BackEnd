...
-- 테이블 데이터 flapper_moonshine.cocktail_recipe:~48 rows (대략적) 내보내기
INSERT INTO `cocktail_recipe` (`recipe_id`, `name`, `ingredient1_id`, `ingredient1_amount`, `ingredient2_id`, `ingredient2_amount`, `ingredient3_id`, `ingredient3_amount`, `ingredient4_id`, `ingredient4_amount`, `garnish_id`, `method`, `ice_in_shake`, `is_on_the_rocks`, `glass_type`, `abv`, `summary`, `comments`, `creator_id`, `created_at`) VALUES
